...
export const NoticeModal: React.FC = () => {
    ...
    return (
        <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 bg-black/60 backdrop-blur-md animate-in fade-in duration-300">
            <div className="w-full max-w-[450px] bg-card border border-border/50 rounded-3xl shadow-[0_32px_64px_-12px_rgba(0,0,0,0.5)] overflow-hidden scale-in-center animate-in zoom-in-95 duration-300">
                ...
                <div className="relative p-6 pb-0 group">
                    ...
                    <div className="flex items-start gap-4">
                        ...
                        <div className="pt-1">
                            <h2 className="text-xl font-bold text-foreground tracking-tight">{currentNoticeDetail.title}</h2>
                            <p className="text-[11px] text-muted-foreground font-mono mt-1 opacity-70">{currentNoticeDetail.date}</p>
                        </div>
                    </div>
                </div>
